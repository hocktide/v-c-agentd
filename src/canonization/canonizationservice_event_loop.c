...
/* forward decls */
static void canonizationservice_control_read(
    ipc_socket_context_t* ctx, int event_flags, void* user_context);
static void canonizationservice_control_write(
    ipc_socket_context_t* ctx, int event_flags, void* user_context);
static void canonizationservice_data_read(
    ipc_socket_context_t* ctx, int event_flags, void* user_context);
static void canonizationservice_random_read(
    ipc_socket_context_t* ctx, int event_flags, void* user_context);
