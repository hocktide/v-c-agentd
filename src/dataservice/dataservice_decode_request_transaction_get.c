/**
 * \file dataservice/dataservice_decode_request_transaction_get.c
 *
 * \brief Decode transaction get request payload.
 *
    ...
    const void* req, size_t size, dataservice_request_transaction_get_t* dreq)
{
    ...
    /* the remaining payload size should be equal to the size of the txn id. */
