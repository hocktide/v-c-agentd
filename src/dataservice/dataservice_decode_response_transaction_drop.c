/**
 * \file dataservice/dataservice_decode_response_transaction_drop.c
 *
 * \brief Decode the response from the transaction drop api method.
 *
    ...
    dataservice_response_transaction_drop_t* dresp)
{
    ...
    if (DATASERVICE_API_METHOD_APP_PQ_TRANSACTION_DROP !=
