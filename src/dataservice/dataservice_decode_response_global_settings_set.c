/**
 * \file dataservice/dataservice_decode_response_global_settings_set.c
 *
 * \brief Decode the response from the global settings set api.
 *
    ...
    dataservice_response_global_settings_set_t* dresp)
{
    ...
    if (DATASERVICE_API_METHOD_APP_GLOBAL_SETTING_WRITE !=
