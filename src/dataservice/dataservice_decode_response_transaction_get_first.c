/**
 * \file dataservice/dataservice_decode_response_transaction_get_first.c
 *
 * \brief Decode the response from the transaction get first api method.
 *
    ...
    dataservice_response_transaction_get_first_t* dresp)
{
    ...
    if (DATASERVICE_API_METHOD_APP_PQ_TRANSACTION_FIRST_READ !=
