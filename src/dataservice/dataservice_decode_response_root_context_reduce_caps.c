/**
 * \file dataservice/dataservice_decode_response_root_context_reduce_caps.c
 *
 * \brief Decode the response from the root context reduce caps api method.
 *
    ...
    dataservice_response_root_context_reduce_caps_t* dresp)
{
    ...
    if (DATASERVICE_API_METHOD_LL_ROOT_CONTEXT_REDUCE_CAPS !=
