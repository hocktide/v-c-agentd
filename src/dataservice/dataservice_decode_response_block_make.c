/**
 * \file dataservice/dataservice_decode_response_block_make.c
 *
 * \brief Decode the response from the block make api method.
 *
    ...
    dataservice_response_block_make_t* dresp)
{
    ...
    if (DATASERVICE_API_METHOD_APP_BLOCK_WRITE !=
