/**
 * \file dataservice/dataservice_decode_response_transaction_promote.c
 *
 * \brief Decode the response from the transaction promote api method.
 *
    ...
    dataservice_response_transaction_promote_t* dresp)
{
    ...
    /* | Transaction promote response packet.                               | */
    /* | --------------------------------------------------- | ------------ | */
    /* | DATA                                                | SIZE         | */
    /* | --------------------------------------------------- | ------------ | */
    ...
    if (DATASERVICE_API_METHOD_APP_PQ_TRANSACTION_PROMOTE !=
