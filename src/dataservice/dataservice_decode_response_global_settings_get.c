/**
 * \file dataservice/dataservice_decode_response_global_settings_get.c
 *
 * \brief Decode the response from the global settings get API method.
 *
    ...
    dataservice_response_global_settings_get_t* dresp)
{
    ...
    if (DATASERVICE_API_METHOD_APP_GLOBAL_SETTING_READ !=
    ...
    /* set the data size. */
    dresp->data_size = size - response_packet_size;

    /* set the data pointer. */
    dresp->data = (void*)(val + 3);
