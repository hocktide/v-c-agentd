/**
 * \file dataservice/dataservice_decode_response_block_id_by_height_get.c
 *
 * \brief Decode the response from the block id by height get api method.
 *
    ...
    dataservice_response_block_id_by_height_get_t* dresp)
{
    ...
    /* | Block id get by height response packet.                            | */
    /* | --------------------------------------------------- | ------------ | */
    /* | DATA                                                | SIZE         | */
    /* | --------------------------------------------------- | ------------ | */
    ...
    if (DATASERVICE_API_METHOD_APP_BLOCK_ID_BY_HEIGHT_READ !=
