/**
 * \file dataservice/dataservice_decode_response_child_context_close.c
 *
 * \brief Decode the response from the child context close api method.
 *
    ...
    dataservice_response_child_context_close_t* dresp)
{
    ...
    if (DATASERVICE_API_METHOD_LL_CHILD_CONTEXT_CLOSE !=
