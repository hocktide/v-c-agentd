/**
 * \file agentd/listenservice.h
 *
 * \brief Service level API for the listen service.
 *
 * \copyright 2019 Velo Payments, Inc.  All rights reserved.
 */

#ifndef AGENTD_LISTENSERVICE_HEADER_GUARD
#define AGENTD_LISTENSERVICE_HEADER_GUARD
 ...
 */
enum listenservice_api_method_enum
{
    /**
     * \brief Lower bound of the API methods.  Must be the first value in this
     * enumeration.
     */
    LISTENSERVICE_API_METHOD_LOWER_BOUND,

    /**
     * \brief Get current connection status.
     */
    LISTENSERVICE_AUTH_API_METHOD_CONNECTION_STATUS_GET,
     ...
     */
    LISTENSERVICE_API_METHOD_UPPER_BOUND
};
...
#endif /*AGENTD_LISTENSERVICE_HEADER_GUARD*/
